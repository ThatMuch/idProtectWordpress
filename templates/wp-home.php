			...
			<div class="row g-3">
				<div class="col-lg-4">
					<div class="blog__left">
						...
						<a href="<?php echo site_url();  ?>/category/particulier" class="btn btn--primary btn--outlined">Tous les articles</a>
					</div> <!-- end blog left -->
				</div>
				<div class="col-lg-8">
			...
			<div class="row g-3 mt-4">
				<div class="col-lg-4">
					<div class="blog__left">
						...
						<a href="<?php echo site_url();  ?>/category/professionnel" class="btn btn--primary btn--outlined">Tous les articles</a>
					</div> <!-- end blog left -->
				</div>
				<div class="col-lg-8">
					<div class="blog__list owl-carousel">
