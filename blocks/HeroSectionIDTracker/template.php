		...
		?>
			<div class="heroSection__card">
				...
				<form action="" method="POST" class="heroSection__card__form">
					...
					<button class="btn btn--secondary btn--solid" type="submit" aria-label="<?php echo esc_attr($button_text); ?>">
						<i class="btn__icon fa fa-bell"></i>
		...
		?>
			<div class="heroSection__card">
				...
				<form action="" method="POST" class="heroSection__card__form">
					...
					<button class="btn btn--secondary btn--solid" type="submit" aria-label="Activer ID Tracker">
						<i class="btn__icon fa fa-bell"></i>
						Activer ID Tracker
						<i class="btn__icon fa fa-arrow-right"></i>
					</button>
